...
const Fourthbody = () => {
  return (
    ...
    >
      ...
      <br />
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" id='SVG4'>
      ...
      <div style={{ marginTop: '-250px'}}>
        ...
        <span className="Tokenomics_K">K</span>ENOMIC<span style={{ color: 'white'}}>S</span></h1>
